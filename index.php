...
<head>
	...
	body {background:linear-gradient(#6DCFF6,#A155A0);background-attachment: fixed;font-family: 'Open Sans', sans-serif;display: flex;
            flex-direction: column; /* Align children vertically */
            justify-content: center; /* Center children vertically */
            align-items: center;}
	.info {width:950px;background-color:rgba(255, 255, 2555, .5);color:white;padding:10px;border-radius:20px;margin-top: 10px;margin-bottom: 10px;font-size: 1.2em;height:268px;display: flex;justify-content: center;align-items: center;}
	.infoChart {width:950px;background-color:rgba(255, 255, 2555, .5);color:white;padding:10px;border-radius:20px;margin-top: 10px;margin-bottom: 10px;font-size: 1.4em;height:307px;display: flex;justify-content: center;align-items: center;}
...
<iframe src="https://www.meteoblue.com/en/weather/widget/three/tunis_tunisia_2464470?fixed&nocurrent=0&noforecast=0&days=4&tempunit=CELSIUS&windunit=KILOMETER_PER_HOUR&layout=dark"  frameborder="0" scrolling="NO" allowtransparency="true" sandbox="allow-same-origin allow-scripts allow-popups allow-popups-to-escape-sandbox" style="width: 1850px; height: 710px"></iframe>
<?php
...
<div class="info">
	<?php echo date("Y");?><br>
	<?php $r=$conn->query("SELECT MIN(temp) as mini, MAX(temp) as maxi, round(AVG(temp),1) as moy FROM meteo WHERE dt LIKE '".date("Y")."%'");$d = $r->fetch_assoc();?>
